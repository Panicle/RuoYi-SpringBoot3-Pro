...
| 18 | V1.0.23__project_unit_budget.sql | devdm (F:\dmdbms\data\RUOYI) | Claude Code (dmPython) | 2026-08-18 | ✅ 4/4语句成功（首次+幂等复查各一次）：project_unit 加列 dept_id（BIGINT NULL，参与单位对应二级公司）+ 新表 project_unit_budget（11列，课题按单位经费支出预算）+ 唯一索引 idx_pub_pdc（project_id,dept_id,category）+ 测试二级公司数据（设计院/检测中心各带1子部门4人，主任挂104+105/科员挂105）；DB复查（dept_id列/新表/唯一索引/两公司各1子部门/每部4人均挂researcher）全部 PASS |
